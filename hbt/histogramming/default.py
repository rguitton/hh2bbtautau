...
default_all_weights = default.derive("default_all_weights", cls_dict={})

for i in range(1, len(differents_weights) + 1):
    to_drop = set(differents_weights[:i])
    to_drop |= {"normalization_weight_inclusive"}
